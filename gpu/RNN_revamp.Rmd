...
```{r, echo=T}
source("mx.io.bucket.iter.mask.R")
source("rnn.graph.R")
source("rnn.R")
source("rnn.train.R")
```
...
The regular regular training process involves binding the symbol to the executors only once. Then, at each iteration, the data and the parameters are updated. With bucketing, a new symbol is binded to the executors at each iteration. 
...
rnn_graph_seq_one <- rnn.unroll.cudnn(seq.len=5, 
                                num.rnn.layer = 2, 
                                num.hidden = 20,
                                input.size=100,
                                num.embed=16, 
...
rnn_graph_seq_one_mask <- rnn.unroll.cudnn(seq.len=5, 
                                num.rnn.layer = 2, 
                                num.hidden = 20,
                                input.size=100,
                                num.embed=16, 
...
graph.viz(rnn_graph_seq_one, type = "graph", direction = "LR", graph.height.px = 200, graph.width.px = 700, shape=c(5, 64))
graph.viz(rnn_graph_seq_one_mask, type = "graph", direction = "LR", graph.height.px = 250, graph.width.px = 700, shape=c(5, 64))
...
rnn_graph_one_one <- rnn.unroll.cudnn(seq.len=5, 
                                num.rnn.layer = 2, 
                                num.hidden = 20,
                                input.size=100,
                                num.embed=16, 
...
rnn_graph_one_one_mask <- rnn.unroll.cudnn(seq.len=5, 
                                num.rnn.layer = 2, 
                                num.hidden = 20,
                                input.size=100,
                                num.embed=16, 
...
graph.viz(rnn_graph_one_one, type = "graph", direction = "LR", graph.height.px = 200, graph.width.px = 700, shape=c(5, 64))
graph.viz(rnn_graph_one_one_mask, type = "graph", direction = "LR", graph.height.px = 250, graph.width.px = 700, shape=c(5, 64))
