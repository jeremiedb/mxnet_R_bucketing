...
# source("rnn.graph.R")
# source("old/patch_initializer.R")
# source("model.rnn.R")
# source("rnn.infer.R")
```
...
nodes_1 <- DiagrammeR::create_node_df(n = 1, label = c("this movie is a great movie"), level = 1, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black", width=3)
nodes_2 <- DiagrammeR::create_node_df(n = 6, label = c("this", "movie", "is", "a", "great", "movie"), level = 2, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black")
...
render_graph(graph1, height = 100)

nodes_3 <- DiagrammeR::create_node_df(n = 1, label = c("worst movie ever"), level = 1, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black", width=2.5)
nodes_4 <- DiagrammeR::create_node_df(n = 6, label = c("worst", "movie", "ever", "<PAD>", "<PAD>", "<PAD>"), level = 2, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black")
...
render_graph(graph2, height = 100)
```
...
nodes_1 <- DiagrammeR::create_node_df(n = 2, label = c("this movie is a great movie", "Bucket_6"), level = 1, fillcolor = adjustcolor(c("lightblue", "lightgreen"), alpha.f = 0.25), style = "filled", shape = "box", color = c("lightblue", "lightgreen"), fontcolor = "black", width=c(3,1))
nodes_2 <- DiagrammeR::create_node_df(n = 6, label = c("this", "movie", "is", "a", "great", "movie"), level = 2, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black")
...
render_graph(graph1, height = 150)

nodes_3 <- DiagrammeR::create_node_df(n = 2, label = c("worst movie ever", "Bucket_4"), level = 1, fillcolor = adjustcolor(c("lightblue", "lightgreen"), alpha.f = 0.25), style = "filled", shape = "box", color = c("lightblue", "lightgreen"), fontcolor = "black", width=c(2.5, 1))
nodes_4 <- DiagrammeR::create_node_df(n = 4, label = c("worst", "movie", "ever", "<PAD>"), level = 2, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black")
...
render_graph(graph2, height = 150)
```
...
# sample 1
nodes_1 <- DiagrammeR::create_node_df(n = 6, label = c("this", "movie", "is", "a", "great", "movie"), level = 2, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black")
nodes_2 <- DiagrammeR::create_node_df(n = 6, label = c("1", "2", "3", "4", "5", "2"), level = 2, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black")
nodes_3 <- DiagrammeR::create_node_df(n = 6, label = c("0.11\n0.65", "-0.21\n0.52", "-0.44\n0.84", "0.89\n0.04", "1.88\n2.59", "-0.21\n1.52"), level = 2, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black")
...
render_graph(graph, height = 150)

# sample 2
nodes_1 <- DiagrammeR::create_node_df(n = 4, label = c("worst", "movie", "ever", "<PAD>"), level = 2, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black")
nodes_2 <- DiagrammeR::create_node_df(n = 4, label = c("7", "2", "8", "0"), level = 2, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black")
nodes_3 <- DiagrammeR::create_node_df(n = 4, label = c("0.77\n0.35", "-0.21\n0.52", "-0.14\n-0.49", "0.00\n0.00"), level = 2, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black")
...
```{r logger1, echo=FALSE, eval=TRUE}
...
```{r logger2, echo = FALSE, eval = TRUE}
p <- plot_ly(x = seq_len(length(logger$train)), y = logger$train, 
             type = "scatter", mode = "markers+lines", name = "train") %>% 
  add_trace(y = logger$eval, type = "scatter", mode = "markers+lines", name = "eval") %>% 
  layout(font = list(size=20))
