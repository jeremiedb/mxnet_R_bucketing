...
nodes_1 <- DiagrammeR::create_node_df(n = 1, label = c("this movie is a great movie"), level = 1, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black")
...
nodes_3 <- DiagrammeR::create_node_df(n = 1, label = c("worst movie ever"), level = 1, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black")
...
nodes_1 <- DiagrammeR::create_node_df(n = 2, label = c("this movie is a great movie", "Bucket_6"), level = 1, fillcolor = adjustcolor(c("lightblue", "lightgreen"), alpha.f = 0.25), style = "filled", shape = "box", color = c("lightblue", "lightgreen"), fontcolor = "black")
nodes_2 <- DiagrammeR::create_node_df(n = 6, label = c("this", "movie", "is", "a", "great", "movie"), level = 2, fillcolor = adjustcolor("lightblue", alpha.f = 0.25), style = "filled", shape = "box", color = "lightblue", fontcolor = "black")
...
nodes_3 <- DiagrammeR::create_node_df(n = 2, label = c("worst movie ever", "Bucket_4"), level = 1, fillcolor = adjustcolor(c("lightblue", "lightgreen"), alpha.f = 0.25), style = "filled", shape = "box", color = c("lightblue", "lightgreen"), fontcolor = "black")
