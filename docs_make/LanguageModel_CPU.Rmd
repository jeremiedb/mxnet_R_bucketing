...
# optimizer <- mx.opt.create("rmsprop", learning.rate = 2e-3, gamma1 = 0.95, gamma2 =0.95, 
#                            wd = 1e-8, clip_gradient = 5, rescale.grad = 1/batch.size)
...
system.time(
  model <- mx.model.buckets(symbol = symbol,
                            ...
                            num.round = 20, ctx = ctx, verbose = TRUE,
