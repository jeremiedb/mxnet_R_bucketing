...
In this minimalistic example, embeddings are only 2 dimensionnal, though it still provides enough seperation potential for the classifier to achieve over 86% accuracy. 
