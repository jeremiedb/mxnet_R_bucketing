...
model_sentiment_lstm <- mx.rnn.buckets(train.data = train.data, eval.data = eval.data, 
                                       ...
                                       num.label = 2, input.size = vocab, 
                                       dropout = 0.25,
                                       cell.type = "gru", config = "seq-to-one", 
                                       batch.end.callback = batch.end.callback, 
                                       epoch.end.callback = epoch.end.callback,
                                       verbose = TRUE, cudnn = TRUE)

mx.model.save(model_sentiment_lstm, prefix = "../models/model_sentiment_lstm", iteration = 25)
